...
void main(void)
{
	...
	{
		money=10*0.1+(x-10)*0.075;
	}
	else if(x>20&&x<=40)
	{
		money=10*0.1+10*0.075+(x-20)*0.05;
	}
	else if(x>40&&x<=60)
	{
		money=10*0.1+10*0.075+20*0.05+(x-40)*0.03;
	}
	else if(x>60&&x<=100)
	{
		money=10*0.1+10*0.075+20*0.03+20*0.03+(x-60)*0.015;	
	}
	else
	{
		money=10*0.1+10*0.075+20*0.03+20*0.03+40*0.015+(x-100)*0.01;
	}
	printf("奖金(单位:万): %.3lf\n",money);
}
